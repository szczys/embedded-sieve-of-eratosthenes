...
program: gcc/$(PROJ_NAME).bin 
	openocd --file /usr/share/openocd/scripts/board/ek-lm4f120xl.cfg -f extra/tiva-launchpad.cfg -c "tiva_flash gcc/$(PROJ_NAME).bin" -c shutdown
